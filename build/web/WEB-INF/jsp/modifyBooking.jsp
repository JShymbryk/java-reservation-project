...
<body>
 ...
 <form:form action="modifyBooking.htm" method="post" modelAttribute="booking">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0" align="center">
                ...
                <tr>
                    ...
                    <td colspan="2"> <form:input path="checkin" type="text" class="datepicker" name="startDate" size="10" maxlength="10"></form:input></td>
                </tr>
                <tr>
                    <td colspan="2" align="right">Check-Out:
                    </td>
                    <td colspan="2"><form:input path="checkout" type="text" class="datepicker" name="endDate" size="10" maxlength="10"></form:input></td>
                </tr>
 ...
 <form:hidden path="reservationId"></form:hidden> 
  <form:hidden path="roomType"></form:hidden> 
  <form:hidden path="guestId"></form:hidden> 
 <form:errors class="error" path="checkin"></form:errors><br>
 <form:errors class="error" path="checkout"></form:errors><br>
